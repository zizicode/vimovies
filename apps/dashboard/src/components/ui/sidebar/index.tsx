...
const SidebarUI: React.FC = () => {
  ...
  return (
    <div id='sidebar' className='sidebar'>
      ...
      <div 
        className={`nav-item ${location.pathname === '/personas' ? 'active' : ''}`}
      ...
      <div 
        className={`nav-item ${location.pathname === '/generos' ? 'active' : ''}`}
        style={{paddingLeft:'24px',fontSize:'12.5px'}}
      ...
      <div 
        className={`nav-item ${location.pathname === '/plataformas' ? 'active' : ''}`}
        style={{paddingLeft:'24px',fontSize:'12.5px'}}
      ...
      <div 
        className={`nav-item ${location.pathname === "/seo" ? "active" : ""}`}
      ...
      <div 
        className={`nav-item ${location.pathname === '/sincronizacion' ? 'active' : ''}`}
